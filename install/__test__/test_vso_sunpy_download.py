...
class TestVsoDownload(unittest.TestCase):
    ...
    def test_getImageGroup(self):
        ...
        URL = "http://%s:%s/?action=getSciDataScript&imageScale=4.84088176&sourceIds=[13,10]&startDate=2021-06-01T00:01:00Z&endDate=2021-06-01T00:02:00Z&lang=sunpy&provider=vso" % (os.environ['HV_HOST'], os.environ['API_PORT']);
