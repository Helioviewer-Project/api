...
class DataServerPauseDelayDefinesDefaultStartTime:
    ...
    def __init__(self, uri, name, pause=60, lag_minutes=0):
        self.uri = uri
        self.name = name
        self.pause = datetime.timedelta(minutes=pause)
        self.lag_minutes = datetime.timedelta(minutes=lag_minutes)
    ...
    def get_starttime(self):
        """Default start time to use when retrieving data"""
        return datetime.datetime.utcnow() - self.pause - self.lag_minutes
