...
class Image_ImageType_PUNCHImage extends Image_HelioviewerImage {
     ...
     *
     * Note: More accurate values for radii used to generate the PUNCH C2 & C3 alpha masks:
     *  rocc_outer = 7.7;   // (.9625 * orig)
     *  rocc_inner = 2.415; // (1.05 * orig)
     *
     *  PUNCH C2 Image Scale
     *      $lascoC2Scale = 11.9;
     *
     ...
     *          -fill black -draw \"circle $crpix1,$crpix2 $crpix1,$innerCircleY\" +antialias PUNCH_C2_Mask.png")
     *
    ...
    //     $maskHeight = 1040;
    //     $mask       = HV_ROOT_DIR
    //                 . '/resources/images/alpha-masks/PUNCH_'
	...
	// 	$o// ffsetX = $this->offsetX;
	// 	$o// ffsetY = $this->offsetY;
