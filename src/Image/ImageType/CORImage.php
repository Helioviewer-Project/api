...
class Image_ImageType_CORImage extends Image_HelioviewerImage {
     ...
     * an alpha mask
     *
     * Note: More accurate values for radii used to generate the
     * COR C2 & C3 alpha masks:
     ...
     *              -size 1024x1024 xc:black
                    -fill white
     *              -draw \"circle $crpix1,$crpix2 $crpix1,$outerCircleY\"
     *              -fill black
     *              -draw \"circle $crpix1,$crpix2 $crpix1,$innerCircleY\"
     *              +antialias COR_C2_Mask.png")
     *
     *  Masks have been pregenerated and stored in order to improve
     *  performance.
     *
     *  Note on offsets:
     *
     *    The original CRPIX1 and CRPIX2 values used to determine the location
     *    of the center of the sun in the image are specified with respect to
     *    a bottom-left corner origin. The values passed in to this method
     *    from the tile request, however, specify the offset with respect to a
     *    top-left corner origin. This simply makes things a bit easier since
     *    ImageMagick also treats images as having a top-left corner origin.
     *
     *  Region of interest:
     *
     *    The region of interest (ROI) below is specified at the original JP2
     *    image scale.
     *
    ...
    protected function setAlphaChannel(&$imagickImage) {
        ...
        // $maskTopLeft coordinates cannot be negative when cropping, so if
        // they are, adjust the width and height by the negative offset and
        // crop with zero offsets. Then put the image on the properly-sized
        // image and offset it correctly.
        ...
        // Rounding cannot be done in the previous lines of code because some
        // addition needs to take place first.
