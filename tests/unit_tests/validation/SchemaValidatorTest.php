...
final class SchemaValidatorTest extends TestCase
{
    ...
    private static function GetTestData(): array {
        ...
        foreach ($valid_files as $file) {
            ...
            $test_data["valid/".$file] = SHOULD_PASS;
        }
        ...
        foreach ($invalid_files as $file) {
            ...
            $test_data["invalid/".$file] = SHOULD_FAIL;
        }
        return $test_data;
    }

    public function test_ValidateJsonSchema(): void
    {
        // Get all test files
        $test_data = SchemaValidatorTest::GetTestData();

        // Run the validator on every file and verify the expected pass/fail result.
        foreach ($test_data as $json_file => $expected_result) {
            $schema = "https://api.helioviewer.org/schema/client_state.schema.json";
