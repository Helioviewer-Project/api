...
define('HV_PROXY_HOST', 'https://gs600-squid.ndc.nasa.gov:443');
define('HV_PROXY_USER_PASSWORD', '');

/**
 * A set of valid cross domain requests
 */
$valid_requests = array(
    'https://helioviewer.org:8090/',
    'https://api.helioviewer.org:8090/',
    'https://helioviewer.org/',
    'https://api.helioviewer.org/',
    'https://api.helioviewer.org/index.php'
);
...
//if($request_method != 'GET'){
	...
	if(!empty(HV_PROXY_HOST)){
		curl_setopt($ch, CURLOPT_PROXY, HV_PROXY_HOST);
		if(!empty(HV_PROXY_USER_PASSWORD)){
			curl_setopt($ch, CURLOPT_PROXYUSERPWD, HV_PROXY_USER_PASSWORD);
		}
	}
...
/*}else{
	...
	try {
		$response_content = file_get_contents($request_url);echo $response_content;
