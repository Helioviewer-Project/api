...
/**
 * One-shot migration: rewrite screenshots.eventsState from the legacy
 * events-tree blob to the canonical { event_selections,
 * event_visibility_selections } shape.
 *
...
echo "screenshots: $verb $migrated, skipped $skipped (already new-shape)\n";
